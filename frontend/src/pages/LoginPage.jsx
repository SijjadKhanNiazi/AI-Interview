    ...
    <div className="min-h-screen bg-[#0D0D1A] flex items-center justify-center p-4 relative overflow-hidden selection:bg-purple-500 selection:text-white">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-violet-600 via-purple-600 to-indigo-600 hover:opacity-95 text-white text-sm font-semibold py-3 rounded-xl shadow-lg shadow-purple-600/20 active:scale-[0.99] transition-transform"
          >
            Sign in
          </button>
        </form>
